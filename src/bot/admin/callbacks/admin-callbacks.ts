export const AdminCallbacks = {
    ...
    ScheduleUpcomingMore: 'up:more',
    ScheduleUpcomingOpenPrefix: 'up:o:',
    ScheduleUpcomingPublishPrefix: 'up:p:',
    ScheduleUpcomingExceptionPrefix: 'up:e:',
    ...
    PlayerTelegramAmbiguousOpenPrefix: 'tir:a:',
    PlayerTelegramOverviewPrefix: 'tir:b:',
